...
model = Sequential()
model.add(LSTM(15, activation= 'relu', kernel_initializer='uniform', kernel_constraint=maxnorm(4), return_sequences=True, input_shape=(n_steps, n_features)))
model.add(LSTM(15, activation= 'relu', kernel_initializer='uniform',return_sequences=True, kernel_constraint=maxnorm(4)))
model.add(LSTM(15, activation= 'relu', kernel_initializer='uniform', kernel_constraint=maxnorm(4)))
